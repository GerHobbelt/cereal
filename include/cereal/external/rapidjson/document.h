...
private:
    ...
    enum {
        ...
        kNullFlag = (int)kNullType,
        kTrueFlag = (int)kTrueType | kBoolFlag,
        kFalseFlag = (int)kFalseType | kBoolFlag,
        kNumberIntFlag = (int)kNumberType | kNumberFlag | kIntFlag | kInt64Flag,
        kNumberUintFlag = (int)kNumberType | kNumberFlag | kUintFlag | kUint64Flag | kInt64Flag,
        kNumberInt64Flag = (int)kNumberType | kNumberFlag | kInt64Flag,
        kNumberUint64Flag = (int)kNumberType | kNumberFlag | kUint64Flag,
        kNumberDoubleFlag = (int)kNumberType | kNumberFlag | kDoubleFlag,
        kNumberAnyFlag = (int)kNumberType | kNumberFlag | kIntFlag | kInt64Flag | kUintFlag | kUint64Flag | kDoubleFlag,
        kConstStringFlag = (int)kStringType | kStringFlag,
        kCopyStringFlag = (int)kStringType | kStringFlag | kCopyFlag,
        kShortStringFlag = (int)kStringType | kStringFlag | kCopyFlag | kInlineStrFlag,
        kObjectFlag = (int)kObjectType,
        kArrayFlag = (int)kArrayType,
